                ...
                <div class="col-sm-6">
                    <div class="contactinfo">
                        <ul class="nav nav-pills">
                            <li><a href="#"><i class="fa fa-phone"></i> +44 787612682</a></li>
                            <li><a href="#"><i class="fa fa-envelope"></i> bchisumo74@gmail.com</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-sm-6">
...
<footer id="footer"><!--Footer-->
    ...
    <div class="footer-bottom">
        <div class="container">
            <div class="row">
                <p class="pull-left">Copyright © 2018 Bernard Chisumo. All rights reserved.</p>
                <p class="pull-right">Designed by <span><a target="_blank" href="http://www.themeum.com">Bernard Chisumo</a></span></p>
            </div>
        </div>
    </div>
