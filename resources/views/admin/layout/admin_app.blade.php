...
<div class="navbar">
    <div class="navbar-inner">
        <div class="container-fluid">
            ...
            <a class="brand" href="{{ URL::to('/dashboard') }}"><span>Ecommerce Shop</span></a>
                ...
                <ul class="nav pull-right">
                    ...
                    <li class="dropdown hidden-phone">
                        ...
                        <ul class="dropdown-menu messages">
                            ...
                            <li>
                                <a href="#">
                                    <span class="avatar"><img src="{{URL::to('backend/img/avatar4.jpp') }}" alt="Avatar"></span>
                                    <span class="header">
											<span class="from">
										    	Julie Blank
										     </span>
        ...
        <div id="sidebar-left" class="span2">
            <div class="nav-collapse sidebar-nav">
                <ul class="nav nav-tabs nav-stacked main-menu">
                    ...
                    <li><a href="{{ route('categories.index')}}"><i class="icon-envelope"></i><span class="hidden-tablet"> All Categories</span></a></li>
